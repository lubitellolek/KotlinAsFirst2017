...
fun seconds(hours: Int, minutes: Int, seconds: Int): Int {
    val result = seconds + minutes * 60 + hours * 3600
    return result
}
...
fun travelMinutes(hoursDepart: Int, minutesDepart: Int, hoursArrive: Int, minutesArrive: Int): Int {
    val min = ( hoursArrive - hoursDepart ) * 60
    val result = min + minutesArrive - minutesDepart
    return result
}
...
fun accountInThreeYears(initial: Int, percent: Int): Double {
    val a = initial / 100.0 * percent + initial
    val b = a / 100.0 * percent + a
    val result = b / 100.0 * percent + b
    return result
}
